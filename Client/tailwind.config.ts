...
export default {
  ...
  theme: {
  	extend: {
      fontFamily: {
        sans: ["var(--font-geist-sans)"], // Add Geist Sans
        mono: ["var(--font-geist-mono)"],   // Add Geist Mono
      },
  		colors: {
      ...
      typography: (theme: (path: string) => string) => ({ // Added prose styles for markdown content
        DEFAULT: {
          css: {
            ...
            '--tw-prose-invert-quote-borders': theme('colors.primary / 0.5'),
